...
func _physics_process(_delta: float) -> void:
	if setup == 0:
		for i in wheels:
			...
			i.TyreSettings["Width (mm)"] = 195.0
			i.TyreSettings["Aspect Ratio"] = 40.0
			i.TyreSettings["Rim Size (in)"] = 18.0
		...
		for i in wheels:
			...
			i.TyreSettings["Width (mm)"] = 205.0
			i.TyreSettings["Aspect Ratio"] = 45.0
			i.TyreSettings["Rim Size (in)"] = 17.0
